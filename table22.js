...
import "react-datepicker/dist/react-datepicker.css";
 ...
 class Table22 extends React.Component{
  constructor(props) {
    super(props);
        ...
        <table className="main">
           ...
           <thead>
            ...
            <tr>
              ...
              <td rowSpan="2">{this.props.ref1}</td>
              <td rowSpan="2">{this.props.date ? <DatePicker onChange={this.props.handlechange} selected={this.props.startDate}/>:null}</td>
              <td>
              ...
              <td><input type="text" value={this.props.d4}/></td>
              <td></td>
            ...
            <tr>
              ...
              <td></td>
              <td><input type="text" value={this.props.d5}/></td>
